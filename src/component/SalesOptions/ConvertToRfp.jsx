...
const print=(event)=>{
  ...
  var rfpdoc = function(rfpsubject,rfpintro,Rfpcat,Rfptype,Rfpcatg,enquiry_id,document_index,document_desc,document_path){
  ...
  var rfpdoc1 = new rfpdoc(Rfpsubject,Rfpintro,rfpdoccat,rfptype,Rfpcatg,event.enquiry_id,event.document_index,event.document_desc,event.document_path);
...
const print1=()=>{
  ...
  fetch("https://localhost:7268/Rfp/V1/AddRfp", {
    ...
    body: JSON.stringify({rfpDoc:rfpinputs})
          ...
          {singleData.map((row) => (
            <StyledTableRow  key={row.id}>
              ...
              <StyledTableCell>     <Select
               ...
               <StyledTableCell>
                <button  onClick={()=>print(row)}>Upload</button>
               </StyledTableCell>
