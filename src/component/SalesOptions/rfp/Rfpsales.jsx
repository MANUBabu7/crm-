...
export default function Rfpsales({ idMessage }  ) {
...
<div style={{display:"flex",justifyContent:"space-between",width:"100%"}}>    
              ...
              <StyledTableRow  key={row.rfpr_id}>
               ...
               <StyledTableCell align="center">{row.rfpr_intro_note}</StyledTableCell>
                ...
                <StyledTableCell align="center">{row.rfpr_created_ausr_id} </StyledTableCell>
                 ...
                 <StyledTableCell align="center"onClick={() => handleClick(row.rfpr_id)} ><button>VIEW</button> </StyledTableCell>
               
                 <StyledTableCell align="center" onClick={() => handleClickupdateStatus(row)}   ><button>Assign to user</button></StyledTableCell> 
      ...
      <AssignUser open={openupdate} handleClose={handleClosestatusupdate} singleData={statusdata}singleData1={Allusers} />
