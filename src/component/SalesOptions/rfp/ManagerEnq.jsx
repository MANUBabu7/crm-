...
// import EnqDoc from '..EnqDoc/EnqDoc';
...
export default function ManagerEnq({ idMessage }  ) {
...
const [data1,setData1]=useState([])
  ...
  const [convertrfp, setconvertrfp] = useState([])
...
<div style={{display:"flex",justifyContent:"space-between",width:"100%"}}>    
                    ...
                    <Paper sx={{ minWidth: 240, height: 880, marginRight: 2, textAlign: "center", marginTop: "10px" }} elevation={4}>
                        <FormControl sx={{ width: "180px", marginTop: "20px", }}>
                            ...
                            <Button> <Link to="/Rfp">RFP</Link></Button>
                        </FormControl>
                    </Paper>
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 700, textAlign: "center" }} aria-label="customized table">
          <TableHead> 
            <TableHead> ALL ENQUIRIES </TableHead>
      ...
      <ConvertToRfp open={openRfp} handleClose={handleCloseRfp} singleData={convertrfp} singleData1={Rfpcat}/>
