...
import RFPDoc from './RFPDoc';
import AssignUser from '../AssignUser';
import UpdatestatusRfp from '../UpdatestatusRfp';
...
const [data1,setData1]=useState([])
  ...
  const [AllUser,setAllUser]=useState([])
    ...
    fetch("https://localhost:7268/Rfp/V1/GetAllEnquiryDocuments", {
        method: "POST",
        crossDomain: true,
        headers: {
...
const handlestatusupdate=()=>
{
 ...
 function handleClickAssignuser(rowdata){
  setAssignUser(rowdata)
  setOpenuser(true);
  fetch("https://localhost:7268/Rfp/V1/ToGetAllUsers ", {
        method: "GET",
        crossDomain: true,
        headers: {
            "Content-Type": "application/json",
              ...
              <StyledTableRow  key={row.rfpr_id}>
               ...
               <StyledTableCell align="center">{row.rfpr_intro_note}</StyledTableCell>
                ...
                <StyledTableCell align="center">{row.rfpr_created_ausr_id} </StyledTableCell>
                 ...
                 <StyledTableCell align="center"onClick={() => handleClick(row.rfpr_id)} ><button>VIEW DOCUMENT</button> </StyledTableCell>
               
                 <StyledTableCell align="center"onClick={() => handleClickAssignuser(row)}  ><button>Assign to user</button></StyledTableCell> 
               ...
               <RFPDoc open={open} handleClose={handleClose} singleData={singleData} />
               <AssignUser open={openuser} handleClose={handleCloseAssignuse} singleData={assignUser} singleData1={AllUser}   />
              <UpdatestatusRfp open={openupdate} handleClose={handlestatusupdate} singleData={statusdata} />
